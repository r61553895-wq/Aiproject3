...
var DATA_DIR = isServerless ? import_path.default.join(import_os.default.tmpdir(), "grokson_data") : import_path.default.join(process.cwd(), "data");
...
function saveStore() {
  try {
    ...
    import_fs.default.writeFileSync(DATA_FILE, JSON.stringify(memoryStore, null, 2), "utf-8");
  } catch (err) {
