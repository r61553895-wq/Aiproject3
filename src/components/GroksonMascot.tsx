    ...
    <div className={`relative inline-flex items-center justify-center ${className}`}>
      ...
      {showBubble && size === 'hero' && (
        <motion.div
          ...
          className="absolute -top-3 right-0 sm:right-4 z-20 pointer-events-none"
        >
          <div className="flex items-center gap-2 bg-[#090b10]/95 backdrop-blur-md border border-white/15 px-3 py-1.5 rounded-lg shadow-2xl font-mono text-[11px] text-slate-300">
